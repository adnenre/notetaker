      ...
      (function (e, n) {
        ...
        if (1 < t.length || n.singleLine) {
          for (var r = "", o = 0, a = t.length; o < a; o++)
            r += p('<tr><td class="{0} {1}" {3}="{5}"><div class="{2}" {3}="{5}"></div></td><td class="{0} {4}" {3}="{5}">{6}</td></tr>', [
              l,
              s,
              c,
              m,
  ...
  (r.hljs
    ...
    document.addEventListener("copy", function (e) {
      ...
      !(function (e) {
        ...
        ((n = -1 !== window.navigator.userAgent.indexOf("Edge") ? u(t) : t.toString()), e.clipboardData.setData("text/plain", n), e.preventDefault());
    }));
})(window, document);
